      ...
      <div className="max-w-6xl mx-auto px-6 pb-16">
        <div className="flex flex-col md:flex-row gap-8 items-start">
          ...
          <div className="flex-1">
            {/* Name */}
            <h1 className="text-5xl font-bold text-white mb-4">{profileUser.name}</h1>

            {/* Bio */}
            <p className="text-lg text-slate-300 mb-6 max-w-2xl">
              {profileUser.bio || "Senior writer exploring the intersection of technology and human experience."}
            </p>
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <div className="bg-slate-900/50 backdrop-blur-sm border border-slate-800/50 rounded-lg p-4">
                <div className="flex items-center gap-2 text-cyan-400 mb-1">
                  ...
                  <span className="text-2xl font-bold">{posts.reduce((acc, p) => acc + (p.likes?.length || 0), 0)}</span>
                </div>
      ...
      <div className="bg-gradient-to-b from-transparent to-[#0a0e1a] py-16">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-white mb-3">Articles by {profileUser.name.split(' ')[0]}</h2>
            <p className="text-slate-400">Explore all {totalPosts} articles written by this author</p>
          </div>
                  ...
                  <div className="bg-slate-900/50 backdrop-blur-sm border border-slate-800/50 rounded-xl overflow-hidden hover:border-cyan-500/30 transition-all h-full flex flex-col">
                    ...
                    <div className="p-6 flex flex-col flex-grow">
                      ...
                      <p className="text-sm text-slate-400 mb-4 line-clamp-2 flex-grow">
                        {post.content ? post.content.substring(0, 120) + '...' : 'Exploring technology and innovation...'}
                      </p>
